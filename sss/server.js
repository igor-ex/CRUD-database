...
app.post('/addNewEntry', urlencodedParser, function (req, res) {
    ...
    const sql = `insert into PERSONS (ID, ID_USER, FNAME, LNAME, AGE) values (${req.body.id}, ${req.body.userID}, '${req.body.fName}', '${req.body.lName}', ${req.body.age})`;
...
app.post('/updateEntry', urlencodedParser, function (req, res) {
    ...
    // req.body.userID, req.body.id, req.body.fName, req.body.lName, req.body.age
    const sql = `update PERSONS set FNAME = '${req.body.fName}', LNAME = '${req.body.lName}', AGE = ${req.body.age} where ID = ${req.body.id} and ID_USER = ${req.body.userID}`;
...
app.post('/removeEntry', urlencodedParser, function (req, res) {
    ...
    const sql = `delete from PERSONS where ID = ${req.body.id} and ID_USER = ${req.body.userID}`;
...
app.post('/clearEntry', urlencodedParser, function (req, res) {
    ...
    // req.body.userID,
    const sql = `delete from PERSONS where ID_USER = ${req.body.userID}`;
